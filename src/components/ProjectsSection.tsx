...
const ProjectsSection: React.FC = () => {
  const projects = useMemo(() => [
    ...
    {
      title: 'Unified-DevOps-AI-Dashboard',
      description: 'A modern, interactive dashboard built with Streamlit that unifies DevOps automation, AI/ML tools, and productivity utilities in a single, visually appealing interface.',
      role: 'DevOps Dashboard Engineer',
      stack: ['Streamlit', 'Python', 'AI/ML', 'DevOps', 'Dashboard'],
      icon: Brain,
