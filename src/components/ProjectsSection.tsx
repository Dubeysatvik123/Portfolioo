  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        setError(err.message || 'Error fetching dynamic projects');
      }
    };
    fetchProjects();
  }, []);
  ...
  return (
    <section className="py-20 px-4 relative overflow-hidden min-h-screen">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {error ? <p>Couldn't load CMS data</p> : null}
        {dynamicProjects.length > 0 && (
          <>
            <hr className="my-8" />
            <h2 className="text-2xl font-bold mb-4">Dynamic Projects (from CMS)</h2>
