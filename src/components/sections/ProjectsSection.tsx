...
const ProjectsSection: React.FC = () => {
  ...
  const projects = [
    ...
    {
      title: 'Cognitive Agents in DevOps',
      description: 'Designed and implemented an LLM-powered cognitive agent to enhance observability, automate incident response, and enforce DevSecOps policies in real-time production environments. Demonstrated measurable operational improvements: 44% lower MTTR, 18% higher incident diagnosis accuracy, and 46% reduction in engineer workload. Integrated agentic AI reasoning (ReAct, AutoGen) with policy-as-code governance for secure, explainable, and adaptive reliability engineering.',
      technologies: ['LLM', 'DevSecOps', 'AI', 'Observability', 'Incident Response', 'Policy-as-Code'],
      category: 'AI/DevOps',
      github: '',
      demo: '#',
      ...
      features: [
        '44% lower MTTR',
        '18% higher incident diagnosis accuracy',
        '46% reduction in engineer workload',
        'Agentic AI reasoning (ReAct, AutoGen)',
        'Policy-as-code governance',
      ],
    },
    {
      title: 'Unified AI DevOps Dashboard',
      description: 'Developed a Streamlit-based dashboard integrating Docker, Kubernetes, ML, GenAI, IaC, and automation tools in a modular interface. Leveraged Generative AI to automate AI-related infrastructure generation for Docker, Kubernetes, and cloud environments. Streamlined infrastructure setup and AI operations, enabling faster deployment and reduced manual effort.',
      technologies: ['Streamlit', 'Python', 'AI/ML', 'DevOps', 'Dashboard', 'GenAI', 'IaC'],
      category: 'DevOps',
      github: 'https://github.com/Dubeysatvik123/Unified-DevOps-AI-Dashboard',
      demo: '#',
    ...
    {
      title: 'VedOps – AI-driven DevSecOps-as-a-Service',
      description: 'Designed a multi-agent AI architecture themed on Indian mythology for automated CI/CD, cloud infrastructure management, and security enforcement. Leveraged LangChain Agents for intelligent task orchestration in DevSecOps pipelines. Integrated with AWS services for provisioning, monitoring, compliance checks, and incident response.',
      technologies: ['Streamlit', 'Python', 'AI', 'DevSecOps', 'LLMs', 'Automation', 'LangChain', 'AWS'],
      category: 'DevSecOps',
      github: 'https://github.com/Dubeysatvik123/Vedopsopen',
      demo: '#',
      gradient: 'from-fuchsia-500 to-indigo-600',
      icon: <FaRobot className="w-8 h-8" />,
      features: [
        'Multi-agent AI architecture',
        'Automated CI/CD and cloud management',
        'LangChain Agents for orchestration',
        'AWS integration for provisioning, monitoring, compliance',
